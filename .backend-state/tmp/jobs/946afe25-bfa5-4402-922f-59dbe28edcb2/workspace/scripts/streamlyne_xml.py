...
def detect_unsupported_multi_period_summary(lines: list[str]) -> Optional[str]:
...
def add_text(parent: etree._Element, tag: str, value: Optional[object]) -> etree._Element:
