...
.bgt-num { text-align: right; white-space: nowrap; color: #4f5b6d; min-width: 50px; }
.bgt-amt { text-align: right; white-space: nowrap; min-width: 82px; }
.bgt-funds { font-weight: 600; color: var(--primary-deep); }
